...
def main(args): # args.dataset: KITTI, split: 'train, val, test', det_name: pointrcnn
	# args를 바꿈 
	# load config files
	...
	for cat in cfg.cat_list: 
		...
		# log: ./results/KITTI\\log/log_20220722_12h43m18s_KITTI_val.txt 로그 기록 루트
...
if __name__ == '__main__':
	# dataset: KITTI
 	# split: 'train, val, test'
  	# det_name: pointrcnn
	#args = parse_args()
	args = {"dataset": "KITTI", "split": "test", "det_name": "pointrcnn"}
